...
**Affected:** [`webapp/tax-track/src/lib/auth-server.ts:94`](webapp/tax-track/src/lib/auth-server.ts#L94), [`webapp/tax-track/src/routes/api/auth/$.ts:2`](webapp/tax-track/src/routes/api/auth/$.ts#L2), [`webapp/tax-track/src/lib/user-roles.ts:1`](webapp/tax-track/src/lib/user-roles.ts#L1), [`webapp/tax-track/src/lib/users-module.ts:30`](webapp/tax-track/src/lib/users-module.ts#L30)
...
**Affected:** [`webapp/tax-track/src/routes/api/atc-codes/import.ts:10`](webapp/tax-track/src/routes/api/atc-codes/import.ts#L10), [`webapp/tax-track/src/routes/api/entities/import.ts:10`](webapp/tax-track/src/routes/api/entities/import.ts#L10), [`webapp/tax-track/src/routes/api/masterlist/import.ts:10`](webapp/tax-track/src/routes/api/masterlist/import.ts#L10), [`webapp/tax-track/src/lib/atc-codes-server.ts:152`](webapp/tax-track/src/lib/atc-codes-server.ts#L152), [`webapp/tax-track/src/lib/entities-server.ts:147`](webapp/tax-track/src/lib/entities-server.ts#L147), [`webapp/tax-track/src/lib/masterlist-server.ts:129`](webapp/tax-track/src/lib/masterlist-server.ts#L129)

**Evidence:** None of the three handlers resolves a session or checks a role. Each service deletes the entire table inside a transaction before inserting the supplied CSV rows. Existing route tests successfully invoke these handlers without authentication, for example [`webapp/tax-track/src/routes/api/atc-codes/-import.test.ts:77`](webapp/tax-track/src/routes/api/atc-codes/-import.test.ts#L77).
...
**Affected:** The three import routes above; [`webapp/tax-track/src/lib/atc-codes-server.ts:170`](webapp/tax-track/src/lib/atc-codes-server.ts#L170), [`webapp/tax-track/src/lib/entities-server.ts:165`](webapp/tax-track/src/lib/entities-server.ts#L165), [`webapp/tax-track/src/lib/masterlist-server.ts:148`](webapp/tax-track/src/lib/masterlist-server.ts#L148)
...
**Affected:** [`webapp/tax-track/src/routes/api/s3-object.ts:58`](webapp/tax-track/src/routes/api/s3-object.ts#L58), [`webapp/tax-track/src/lib/access-control.ts:149`](webapp/tax-track/src/lib/access-control.ts#L149), [`webapp/tax-track/src/lib/intake-server.ts:358`](webapp/tax-track/src/lib/intake-server.ts#L358), [`webapp/tax-track/src/routes/api/uploads/batches.$batchId.files.ts:20`](webapp/tax-track/src/routes/api/uploads/batches.$batchId.files.ts#L20), [`webapp/tax-track/src/routes/api/documents.$docId.original-file.ts:25`](webapp/tax-track/src/routes/api/documents.$docId.original-file.ts#L25)
...
**Affected:** [`webapp/tax-track/src/routes/api/uploads/complete.ts:18`](webapp/tax-track/src/routes/api/uploads/complete.ts#L18), [`webapp/tax-track/src/routes/api/uploads/batches.$batchId.ts:59`](webapp/tax-track/src/routes/api/uploads/batches.$batchId.ts#L59), [`webapp/tax-track/src/routes/api/uploads/batches.$batchId.restore.ts:22`](webapp/tax-track/src/routes/api/uploads/batches.$batchId.restore.ts#L22), [`webapp/tax-track/src/lib/intake-server.ts:2132`](webapp/tax-track/src/lib/intake-server.ts#L2132), [`webapp/tax-track/src/lib/intake-server.ts:2175`](webapp/tax-track/src/lib/intake-server.ts#L2175), [`webapp/tax-track/src/lib/intake-server.ts:2373`](webapp/tax-track/src/lib/intake-server.ts#L2373)
...
**Affected:** [`webapp/tax-track/src/routes/__root.tsx:23`](webapp/tax-track/src/routes/__root.tsx#L23), [`webapp/tax-track/src/lib/user-admin-server.ts:38`](webapp/tax-track/src/lib/user-admin-server.ts#L38), [`webapp/tax-track/src/routes/api/users/create.ts:66`](webapp/tax-track/src/routes/api/users/create.ts#L66), [`webapp/tax-track/src/routes/api/users/reset-password.ts:73`](webapp/tax-track/src/routes/api/users/reset-password.ts#L73), [`webapp/tax-track/src/routes/api/uploads/presign.ts:15`](webapp/tax-track/src/routes/api/uploads/presign.ts#L15)
...
**Affected:** [`webapp/tax-track/src/routes/api/users/change-password.ts:64`](webapp/tax-track/src/routes/api/users/change-password.ts#L64), [`webapp/tax-track/src/routes/api/users/reset-password.ts:73`](webapp/tax-track/src/routes/api/users/reset-password.ts#L73), [`webapp/tax-track/src/lib/auth-server.ts:242`](webapp/tax-track/src/lib/auth-server.ts#L242), [`pnpm-lock.yaml:227`](pnpm-lock.yaml#L227)
...
**Affected:** [`webapp/tax-track/package.json:43`](webapp/tax-track/package.json#L43), [`pnpm-lock.yaml:227`](pnpm-lock.yaml#L227), [`webapp/tax-track/src/lib/reconciliation-server.ts:343`](webapp/tax-track/src/lib/reconciliation-server.ts#L343)
...
**Affected:** [`webapp/tax-track/src/lib/intake-utils.ts:41`](webapp/tax-track/src/lib/intake-utils.ts#L41), [`webapp/tax-track/src/lib/intake-server.ts:2425`](webapp/tax-track/src/lib/intake-server.ts#L2425), [`backend/worker/src/langgraph/utils/pageProcessing.ts:40`](backend/worker/src/langgraph/utils/pageProcessing.ts#L40), [`webapp/tax-track/src/lib/signing-module.ts:86`](webapp/tax-track/src/lib/signing-module.ts#L86), [`webapp/tax-track/src/lib/signing-server.ts:290`](webapp/tax-track/src/lib/signing-server.ts#L290)
...
**Affected:** [`webapp/tax-track/src/lib/auth-server.ts:71`](webapp/tax-track/src/lib/auth-server.ts#L71), [`webapp/tax-track/src/lib/audit.ts:92`](webapp/tax-track/src/lib/audit.ts#L92)
...
**Affected:** [`webapp/tax-track/src/routes/api/s3-object.ts:136`](webapp/tax-track/src/routes/api/s3-object.ts#L136), [`v1_poc/app/api/routes/extraction.py:57`](v1_poc/app/api/routes/extraction.py#L57), [`backend/worker/src/app.ts:83`](backend/worker/src/app.ts#L83)
