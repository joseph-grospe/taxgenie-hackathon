...
describe('/login route', () => {
  it('renders the TaxGenie identity and email/password form when unauthenticated', () => {
    renderLogin()

    expect(screen.getByRole('heading', { name: 'TaxGenie' })).toBeTruthy()
    ...
    expect(screen.getByText('Sign in to TaxGenie')).toBeTruthy()
