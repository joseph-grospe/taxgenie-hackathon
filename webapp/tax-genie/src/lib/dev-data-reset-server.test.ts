...
describe('resetDevData', () => {
  ...
  it('collects counts and truncates only the allowlisted runtime tables', async () => {
    ...
    expect(truncateStatement).toContain('"extracted_certificates"')
    expect(truncateStatement).toContain('"certificate_tax_rows"')
    expect(truncateStatement).toContain('"document_extraction_attempts"')
    expect(truncateStatement).toContain('"certificate_override_changes"')
    expect(truncateStatement).toContain('"result_artifacts"')
