...
const buildDashboardTourSteps = ({
  ...
  navSteps.push({
    ...
    title: 'User menu',
    content:
      'Use the profile menu to open account settings or sign out when you are finished working in TaxGenie.',
  ...
  return [
    ...
    },
    {
      ...
      content:
        'Use this header button to open the navigation sidebar when you need to move between TaxGenie work areas.',
      placement: 'bottom-start',
    },
    {
...
const buildAuditTourSteps = (): Array<Step> => [
  createTargetStep({
    ...
    title: 'Audit Trail',
    content:
      'Use this page to inspect immutable user and system activity across TaxGenie.',
    placement: 'bottom-start',
  }),
  createTargetStep({
