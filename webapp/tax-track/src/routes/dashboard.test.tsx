...
describe('/dashboard route behavior', () => {
  it('wires the dashboard product tour into the header and page sections', () => {
    ...
    expect(sidebarSource).toContain('label="Step 1: Intake"')
    expect(sidebarSource).toContain('label="Step 2: Review"')
    expect(sidebarSource).toContain('label="Step 3: Merge"')
    expect(sidebarSource).toContain('label="Admin"')
    expect(sidebarSource).not.toContain('label="Workflow"')
    expect(sidebarSource).not.toContain('label="Exports"')
