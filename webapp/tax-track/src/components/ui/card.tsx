...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'border-border/70 bg-card text-card-foreground gap-6 overflow-hidden rounded-lg border py-6 text-sm has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-md *:[img:last-child]:rounded-b-md group/card flex flex-col',
        className,
      )}
      {...props}
    />
