...
export function DashboardValidatedDocumentsTable({
    ...
    <>
        ...
        <Table className="min-w-[720px] text-xs">
          <TableHeader className="sticky top-0 z-10 bg-muted/60">
            <TableRow>
              ...
              <TableHead className="h-9 min-w-[200px] px-2">Customer</TableHead>
      ...
      <div className="mt-2 flex flex-wrap items-center justify-between gap-2 text-[11px] text-muted-foreground">
        <span>
          ...
          {filteredRows.length.toLocaleString()} documents
        </span>
  ...
  if (presentation === 'embedded') {
    return (
      <section aria-label="Validated documents" className="min-w-0">
  ...
  return (
    <Card size="sm" className="h-full shadow-none ring-0">
