...
const BRAND_NAME = 'TaxTrack'
const NOTIFICATION_FROM_EMAIL = 'TaxTrack <notifications@taxtrack.online>'
const EMAIL_THEME = {
  background: '#f5f5f5',
  border: '#e5e5e5',
  card: '#ffffff',
...
const STATUS_CONTENT = {
  deactivated: {
    ...
    summary:
      'An administrator deactivated access for this account. You can no longer sign in to TaxTrack.',
    detail:
