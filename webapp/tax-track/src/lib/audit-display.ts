...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  batch_purge_requested: 'Batch purge requested',
  ...
  document_extraction_retried: 'Extraction retried',
  document_purge_requested: 'Document purge requested',
  ...
  reference_data_imported: 'Reference data imported',
  reference_data_row_created: 'Reference data row created',
  reference_data_row_deleted: 'Reference data row deleted',
  reference_data_row_updated: 'Reference data row updated',
