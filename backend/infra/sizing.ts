  ...
  return {
    ...
    worker: {
      ...
      instanceType: optionalInstanceType(
        "workerInstanceType",
        "TAXGENIE_WORKER_INSTANCE_TYPE",
        base.worker.instanceType,
      ),
      concurrency: optionalInteger(
        "workerConcurrency",
        "TAXGENIE_WORKER_CONCURRENCY",
