...
ALTER TABLE "document_results" DROP CONSTRAINT IF EXISTS "document_results_batch_id_intake_batches_id_fk";--> statement-breakpoint
ALTER TABLE "intake_files" DROP CONSTRAINT IF EXISTS "intake_files_batch_id_intake_batches_id_fk";--> statement-breakpoint
ALTER TABLE "worker_jobs" DROP CONSTRAINT IF EXISTS "worker_jobs_batch_id_intake_batches_id_fk";--> statement-breakpoint
