...
CREATE INDEX IF NOT EXISTS document_results_source_file_revision_idx
  ON document_results (source_file_id, revision);

CREATE INDEX IF NOT EXISTS document_results_outcome_idx
  ON document_results (outcome);
