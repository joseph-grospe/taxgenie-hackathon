...
from modules.samples.models.classification import Classifications
from modules.samples.utils.value_utils import flatten_dict
    ...
    for classification in expected.classifications:
        ...
        if confidence is not None:
            row["Confidence"] = confidence_flat.get(
                f"classifications_{classification.page_number}_classification_confidence",
                None,
            )
